(function () {
    ...
    function captureFiles() {
        ...
        const manifest = {
            ...
            application: setup.BuildInfo && setup.BuildInfo.productName || "Mallowstead",
            productName: setup.BuildInfo && setup.BuildInfo.productName || "Mallowstead",
            buildIdentity: {
                productName: setup.BuildInfo && setup.BuildInfo.productName || "Mallowstead",
                version: setup.BuildInfo && setup.BuildInfo.version || "unknown",
                profile: setup.BuildInfo && setup.BuildInfo.profile || "unknown",
                commit: setup.BuildInfo && setup.BuildInfo.commit || "unknown",
                builtAt: setup.BuildInfo && setup.BuildInfo.builtAt || null
            },
            buildVersion: setup.BuildInfo && setup.BuildInfo.version || "unknown",
            buildProfile: setup.BuildInfo && setup.BuildInfo.profile || "unknown",
            buildCommit: setup.BuildInfo && setup.BuildInfo.commit || "unknown",
            builtAt: setup.BuildInfo && setup.BuildInfo.builtAt || null,
    ...
    function download() {
        ...
        try {
            ...
            link.href = url;
            link.download = `mallowstead-emergency-dump-${timestampForFilename(new Date())}.zip`;

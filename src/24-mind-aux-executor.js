(function () {
    ...
    function eligible(characterId) {
        ...
        return Boolean(actor && actor.type === "character" && actor.mind && Array.isArray(actor.mind.verbatimObservations) && actor.mind.verbatimObservations.length > setup.MindV3.CONFIG.STM_TRIGGER_COUNT);
    }

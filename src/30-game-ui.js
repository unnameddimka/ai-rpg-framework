(function () {
    ...
    const PRODUCT_DISPLAY_NAME = "AI RPG Framework MVP";
    ...
    function renderSidebar() {
        ...
        root.innerHTML = `
            ...
            <div class="framework-sidebar-block" id="ai-settings-panel">
                ...
                <label><input id="remember-openrouter-key" type="checkbox"> Remember for 7 days</label><br>
        ...
        $("#save-ai-settings").on("click", function () {
            ...
            $("#ai-settings-status").text(result.ok
                ? (result.warning || (result.remembered ? "Key saved for 7 days." : "Key retained in memory for this page."))

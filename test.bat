...
if errorlevel 1 exit /b 1
"%NODE_EXE%" tests\run-starter-character-tests.js
if errorlevel 1 exit /b 1
"%NODE_EXE%" tests\run-ai-tests.js
if errorlevel 1 exit /b 1
"%NODE_EXE%" tests\run-action-contract-repair-tests.js
if errorlevel 1 exit /b 1
...
if errorlevel 1 exit /b 1
"%NODE_EXE%" tests\run-weekly-merchant-tests.js
if errorlevel 1 exit /b 1
"%NODE_EXE%" tests\run-release-profile-tests.js
if errorlevel 1 exit /b 1

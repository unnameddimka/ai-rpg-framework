...
async function main() {
    ...
    place(world.entities.blacksmith, corridor, world);
    place(world.entities.nell, room, world);
    place(world.entities.hoodedWoman, world.entities.villageTemple, world);
    ["player", "blacksmith", "nell", "hoodedWoman"].forEach(id => clearRuntime(world.entities[id]));
    world.ai.turnQueue = [];
    ...
    const sourceObservation = world.entities.blacksmith.mind.pendingObservations.find(o => o.eventType === "passage_interaction_attempted");
    ...
    ["player", "hoodedWoman", "blacksmith"].forEach(function (id) { place(world.entities[id], entrance, world); clearRuntime(world.entities[id]); });
    world.ai.turnQueue = [];
    ...
    assert(world.entities.player.recentDialogue.slice(-1)[0].text === "Hello there" && world.entities.hoodedWoman.recentDialogue.slice(-1)[0].text === "Hello there" &&
        world.entities.blacksmith.recentDialogue.slice(-1)[0].text === "Hello there",
    ...
    world.entities.blacksmith.recentDialogue = [];
    ...
    assert(world.entities.hoodedWoman.recentDialogue.length === 8 && world.entities.hoodedWoman.recentDialogue[0].text === "private line 2" &&
        world.entities.blacksmith.recentDialogue.length === 0,
    ...
    ["hoodedWoman", "blacksmith", "nell"].forEach(function (id) {
    ...
    assert(world.entities.hoodedWoman.mind.pendingObservations.length > 0 && world.ai.continuations.hoodedWoman &&
        world.entities.blacksmith.mind.pendingObservations.length === 0 && world.entities.nell.mind.pendingObservations.length === 0 &&
        !world.ai.continuations.blacksmith && !world.ai.continuations.nell && world.entities.player.mind.pendingObservations.length === 0,

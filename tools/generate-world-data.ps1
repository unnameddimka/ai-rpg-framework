...
$knownActions = @("move","move_within_location","take_item","drop_item","give_item","give_money","place_item","pour_ale","read_aura")
...
Require ($null -ne $document.locations -and $null -ne $document.characters -and $null -ne $document.abilities) "world.json must contain locations, characters, and abilities objects."
